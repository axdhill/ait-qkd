 ...
 * store.h
 * 
 * this is the Q3P KeyStore to KeyStore STORE protocol
 *
...
#ifndef __QKD_Q3P_PROTOCOL_STORE_H_
#define __QKD_Q3P_PROTOCOL_STORE_H_
...
public:
     ...
     */
    store(QAbstractSocket * cSocket, qkd::q3p::engine_instance * cEngine);
...
private:
     ...
     */
    protocol_type protocol_id_internal() const { return protocol_type::PROTOCOL_STORE; };
