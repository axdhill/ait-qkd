...
uint32_t Utils::letbe32(uint32_t little_endian){
...
uint16_t Utils::letbe16(uint16_t little_endian){
	return ((little_endian&0x00ff)<<8)|
		   ((little_endian&0xff00)>>8);
}

std::string Utils::getLinuxErrorCode(int errorcode){
	switch(errorcode){
