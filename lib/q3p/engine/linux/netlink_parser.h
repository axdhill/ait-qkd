...
#ifndef __QKD_Q3P_LINUX_NETLINK_PARSER_H_
#define __QKD_Q3P_LINUX_NETLINK_PARSER_H_
...
public:
     ...
     */
    static std::shared_ptr<netlink_parser> create(unsigned int nNetlinkMessageType);
     ...
     */
    virtual bool parse(netlink_message & cMessage, char * cBuffer, uint32_t nSize) = 0;
