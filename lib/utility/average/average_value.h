 ...
 * average_value.h
 * 
 * moving average over values interface
 *
...
#ifndef __QKD_UTLITY_AVERAGE_VALUE_H_
#define __QKD_UTLITY_AVERAGE_VALUE_H_
...
/**
 * this class is a moving average over values
 * 
 */
class average_value : public average_technique {
...
public:
     ...
     * ctor
     */
    explicit average_value(uint64_t nWindowSize) : average_technique(nWindowSize), m_nSum(0) {};
     ...
     */
    virtual std::string describe() const { return std::string("moving average over values"); };
