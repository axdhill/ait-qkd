 ...
 * checksum_md5.h
 * 
 * interface for the MD5 checksum
 *
...
#ifndef __QKD_CHECKSUM_MD5_H_
#define __QKD_CHECKSUM_MD5_H_
...
/**
 * this class creates MD5 checksums
 */
class checksum_algorithm_md5 : public checksum_algorithm {
...
public:
     ...
     */
    virtual std::string name() { return "md5"; };
