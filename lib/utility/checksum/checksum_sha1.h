 ...
 * checksum_sha1.h
 * 
 * interface for the SHA1 checksum
 *
...
#ifndef __QKD_CHECKSUM_SHA1_H_
#define __QKD_CHECKSUM_SHA1_H_
...
/**
 * this class creates SH1 checksums
 */
class checksum_algorithm_sha1 : public checksum_algorithm {
...
public:
     ...
     */
    virtual std::string name() { return "sha1"; };
