...
#ifndef __QKD_CRYPTO_CRYPTO_EVHASH__H_
#define __QKD_CRYPTO_CRYPTO_EVHASH__H_
...
/**
 * this class holds the evaluation hash authentication
 */
class crypto_evhash : public context {
...
public:
     ...
     */
    explicit crypto_evhash(qkd::key::key const & cKey);
     ...
     */
    static bool is_valid_input_key(qkd::key::key const & cKey);
     ...
     */
    std::string name() { return std::string("evhash"); };
...
private:
     ...
     */
    uint64_t final_key_size_internal() const;
     ...
     */
    bool init_key_reusable_internal() const { return true; };
     ...
     */
    uint64_t init_key_size_internal() const;
     ...
     */
    bool needs_final_key_internal() const { return true; };
     ...
     */
    bool needs_init_key_internal() const { return true; };
     ...
     */
    uint64_t result_size_internal() const;
