 ...
 * crypto_umac.h
 * 
 * interface for the UMAC authentication
 *
...
#ifndef __QKD_CRYPTO_UMAC_H_
#define __QKD_CRYPTO_UMAC_H_
...
/**
 * this class holds the UMAC authentication
 */
class crypto_umac : public context {
...
public:
     ...
     */
    explicit crypto_umac(qkd::key::key const & cKey);
     ...
     */
    std::string name() { return std::string("umac"); };
