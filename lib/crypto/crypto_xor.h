...
/**
 * this class holds the XOR encryption
 */
class crypto_xor : public context {
...
public:
     ...
     */
    explicit crypto_xor(qkd::key::key const & cKey);
     ...
     */
    static bool is_valid_input_key(UNUSED qkd::key::key const & cKey) { return true; };
     ...
     */
    std::string name() { return std::string("xor"); };
...
private:
    ...
    /**
     * why clone a XOR context?
     * 
     * @return  false
     */
    bool is_cloneable_internal() const { return false; };
