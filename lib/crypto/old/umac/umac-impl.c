...
#define UMAC_OUTPUT_LEN     (UMAC_BITS/8)  /* Alowable: 4, 8, 12, 16                  */
...
/* static int uhash(uhash_ctx_t ahc, char *msg, long len, char *res) */
...
/* static int umac_reset(umac_ctx_t ctx) */
...
/* static int umac_delete(umac_ctx_t ctx) */
...
/* static umac_ctx_t umac_new(char key[]) */
...
/* static int umac_final(umac_ctx_t ctx, char tag[], char nonce[8]) */
/* /\* Incorporate any pending data, pad, and generate tag *\/ */
/* { */
...
/* static int umac_update(umac_ctx_t ctx, char *input, long len) */
/* /\* Given len bytes of data, we parse it into L1_KEY_LEN chunks and   *\/ */
...
/* static int umac(umac_ctx_t ctx, char *input,  */
/*          long len, char tag[], */
/*          char nonce[8]) */
