...
int main(int argc, char ** argv) {
    ...
    std::string sApplication = std::string("qkd-auth - AIT QKD Module 'Authentication' V") + qkd::version();
    ...
    cQKDAuth.set_debug_key_sync(cVariableMap.count("debug-key-sync") > 0);
