 ...
 */
void qkd_privacy_amplification::add_metadata_in(boost::property_tree::ptree & cPropertyTree, UNUSED qkd::key::key const & cKey) const {
    cPropertyTree.put("reduction_rate", reduction_rate());
    cPropertyTree.put("security_bits", security_bits());
}
