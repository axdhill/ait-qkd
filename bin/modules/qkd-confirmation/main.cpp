...
int main(int argc, char ** argv) {
    ...
    std::string sApplication = std::string("qkd-confirmation - AIT QKD Module 'Confirmation' V") + qkd::version();
    ...
    cQKDConfirmation.set_debug_key_sync(cVariableMap.count("debug-key-sync") > 0);
