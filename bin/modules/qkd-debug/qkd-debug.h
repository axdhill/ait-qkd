 ...
 * qkd-debug.h
 * 
 * qkd-debug QKD Module definition
 * 
...
#ifndef __QKD_MODULE_QKD_DEBUG_H_
#define __QKD_MODULE_QKD_DEBUG_H_
...
/**
 * The qkd-debug dumps human readable output about the bypassing key
 * 
 * The qkd-debug QKD module supports the ""at.ac.ait.qkd.debug" Interface.
 * 
 * Properties of at.ac.ait.qkd.debug
 * 
 ...
 * 
 */
class qkd_debug : public qkd::module::module {
    
    
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "at.ac.ait.qkd.debug")

    Q_PROPERTY(QString file_url READ file_url WRITE set_file_url)           /**< get/set the file URL to write data to */
...
public:
    ...
    /**
     * sets the new file URL to write to
     * 
...
protected:
     ...
     * 
     * qkd-debug accepts all keys (even disclosed ones).
     * 
